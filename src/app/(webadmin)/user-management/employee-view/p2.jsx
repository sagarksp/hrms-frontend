        ...
        <div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <Select
                    ...
                    value={selectedEmployeeCode} // Link value to state
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              ...
              >
                <Input placeholder="Next EmpCode" readOnly />
              </Form.Item>
    ...
    },
    {
      ...
      content: (
        <div>
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item label="Father Name1" name="fatherName">
                <Input />
              </Form.Item>
            </Col>
            {/* <Col span={12}>
      ...
      content: (
        <div>
          ...
          <Row gutter={16}>
            ...
            maxLength={11} // IFSC code length is always 11 characters
          />
        </Form.Item>
